        ...
        <form>
                                ...
                                <div>
                                        ...
                                        <input
                                            ...
                                            defaultValue={"Saheel"}
                                            className="border border-gray-400 h-[40px] pl-2 w-[355px] text-[#8D98AA] text-[12px] rounded-lg "
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="border border-gray-400 h-[40px] w-[355px] pl-2 text-[#8D98AA] text-[12px] rounded-lg "
