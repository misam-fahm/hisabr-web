...
export function Inputtext(props: any): JSX.Element {
        ...
        {variant === "outline" ? (
          <div
            className={`
					...
					${divClassName || ""} flex w-full items-center relative justify-between rounded-md focus-within:border-white`}
          >
            {leftIcon}
            <input
              id={fieldId}
            ...
            <label
              ...
              className={`text-darklightgrey absolute top-1.5  z-10 origin-[0] ml-5 -translate-y-4 scale-75 bg-[#334155] text-white px-2 text-base duration-300 peer-focus:px-2 ${
                ...
                watch(name) &&
                " top-1.5 -translate-y-4 scale-75 bg-[#334155] px-2"
              }`}
            >
              {placeholder}
  ...
  input {
    ...
    color: white;
    border: 1px solid #334155; /* Add border with the desired color */
  }
  ...
  input:-webkit-autofill:focus {
    ...
    border: 1px solid #334155; /* Ensure border color persists on autofill */
  }
`}</style>
