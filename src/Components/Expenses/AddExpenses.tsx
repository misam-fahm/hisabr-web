...
const AddExpenses = () => {
  ...
  return (
    <>
      <div className="hidden below-md:block justify-end fixed bottom-3 right-6">
        <button
          onClick={openModal}
            ...
            <form onSubmit={handleSubmit}>
              <div className="overflow-y-auto h-[380px] below-md:h-[300px] overflow-x-hidden scrollbar-thin scrollbar-thumb-[#A9A5CA33] scrollbar-track-transparent">
                ...
                <div className="flex flex-col gap-1 mb-3">
                  ...
                  <select
                    name="store"
                    className={`border h-[40px] w-[345px] below-md:w-full pl-2 text-[#8D98AA] text-[12px]  rounded-lg ${
                  ...
                  {errors.store && (
                    <p className="text-red-500 text-[12px]">{errors.store}</p>
                  )}
                </div>
                  ...
                  <div className="flex flex-col mt-1 mb-2">
                    ...
                    <div className="relative w-full">
                      <DatePicker
                        ...
                        className={`border h-[40px] w-[345px] below-md:w-[128%]  pl-3 pr-10 text-[#8D98AA] text-[12px] rounded-lg ${
                          errors.date ? "border-red-500" : "border-gray-300"
                        }`}
                      />
                      <img
                        className="absolute top-1/2 right-3  transform -translate-y-1/2 w-5 h-5 below-md:w-4 below-md:h-4 cursor-pointer "
