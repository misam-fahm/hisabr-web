  ...
  return (
    <>
      ...
      <div className="block below-md:hidden">
        <button
          onClick={openModal}
          className="bg-[#1AA47D] shadow-lg text-white  w-[159px] text-[14px] gap-[0.25rem] font-semibold h-[35px] rounded-md flex items-center justify-center "
        >
          ...
          <DialogPanel className="w-[410px] h-[518px] below-md:w-[94%] below-md:h-[450px] px-6 below-md:px-3 py-6 bg-white rounded-lg shadow-lg flex flex-col">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex items-center mt-3 w-full md:w-full justify-between md:gap-2 space-x-3">
                <button
                  type="button"
                  className="px-4 py-2 below-md:px-2 md:py-1 text-[14px] hover:bg-[#E4E4E4] text-[#6F6F6F] md:h-[36px] w-[158px] below-md:w-[150px] h-[37px] bg-[#E4E4E4] rounded-md"
                  onClick={closeModal}
                >
                  Cancel
                </button>
