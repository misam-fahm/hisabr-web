          ...
          <div className="flex flex-row gap-3 w-full below-md:flex-col below-laptop:w-4/5 small-laptop:w-full">
            ...
            <div className="flex-1 min-w-[150px] below-lg:min-w-[128.04px] h-[35px] below-lg:h-[29.876px] w-full relative">
              <input
                ...
                className="w-full rounded border border-gray-300 bg-white py-[10px] h-[35px] px-3 pr-14 text-[12px] below-lg:text-[10.2432px] placeholder:text-[#636363] focus:outline-none focus:ring-1 focus:ring-white"
              />
              {globalFilter && (
