...
const SalesKPI: FC = () => {
  ...
  return (
    <main className=" max-h-[calc(100vh-70px)] overflow-auto" style={{scrollbarWidth:"thin"}}>
      ...
      <div className=" mb-3">
        <div className="flex flex-row  justify-between pt-3  pl-6 pr-6 pb-3 bg-[#f7f8f9] ">
          <div className="flex flex-row w-full gap-3">
            <div className="w-[20%]">
              ...
              {isOpen && (
                <div
                  className="absolute left-[260px] w-[20%] mt-2 bg-[#ffffff] text-[#4B4B4B] text-[12px] border rounded shadow-md"
                  style={{ zIndex: 50 }}
                >
        ...
        <div className="flex flex-row w-full h-full gap-6 pt-3  pl-6 pr-6">
        ...
        {/* grid 2 */}
        <div className="flex flex-row w-full h-full gap-6 mt-6  pl-6 pr-6">
          <div className="flex flex-row bg-[#FFFFFF] rounded-lg shadow-sm border-[#E5D5D5] border-b-4 w-full h-full min-h-[120px] p-4 justify-between">
            <div>
              <p className="text-[14px] text-[#575F6DCC] font-medium">
                Sales Tax
        ...
        <div className="flex flex-row justify-between items-center rounded-lg bg-white mt-6 shadow-md px-10 ml-6 mr-6">
          <div>
            <DonutChart />
          </div>
          <div>
            <table className="items-center bg-transparent w-full">
              <thead>
                <tr>
                  <th className="px-6 bg-blueGray-50 text-[#737373] text-left border border-solid border-blueGray-300 py-1 text-sm  border-l-0 border-r-0 border-t-0 whitespace-nowrap font-medium ">
                    Label
                  </th>
                  <th className="px-6 bg-blueGray-50 text-[#737373] text-center border border-solid border-blueGray-300 py-1 text-sm border-l-0 border-r-0 border-t-0 whitespace-nowrap font-medium ">
                    Amount
                  </th>
                  <th className="px-6 bg-blueGray-50 text-[#737373] text-center border border-solid border-blueGray-300 py-1 text-sm border-l-0 border-r-0 border-t-0 whitespace-nowrap font-medium">
                    %
              ...
              <tbody>
                {tableData.map((row, index) => (
                  <tr key={index}>
                    <td className="border-t-0 px-6 text-left border-l-0 border-r-0 text-xs whitespace-nowrap p-2 flex items-center text-[#404040] text-[13px]">
                      <div
                    ...
                    <td className="text-[14px] font-medium border-t-0 px-6 text-center border-l-0 border-r-0 text-xs whitespace-nowrap p-2">
                      $ {row.amount}
                    </td>
                    <td className="text-[14px] font-medium border-t-0 px-6 text-center border-l-0 border-r-0 text-xs whitespace-nowrap p-2">
                      {row.per}
