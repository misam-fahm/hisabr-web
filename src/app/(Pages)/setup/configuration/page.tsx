          ...
          <div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex gap-10 mt-4 py-5">
                ...
                {[
                  { name: "monthlyRoyalty", label: "Monthly Royalty", placeholder: "Please enter Monthly Royalty" },
                  { name: "laborSalary", label: "Labor/Salary", placeholder: "Please enter Labor/Salary" },
                ].map(({ name, label, placeholder }) => (
                  <div key={name} className="w-[30%]">
                    <label className="block text-sm font-medium text-[#5E6366]">{label}</label>
                    <input
                      type="text"
                      name={name}
              ...
              <div className="flex gap-10 mt-4 py-5">
                {[
                  ...
                  { name: "mortgage", label: "Mortgage", placeholder: "Please enter Mortgage" },
                ].map(({ name, label, placeholder }) => (
                  <div key={name} className="w-[30%]">
                    <label className="block text-sm font-medium text-[#5E6366]">{label}</label>
                    <input
